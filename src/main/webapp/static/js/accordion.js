  ...
  Accordion.prototype = {
    defaultDOM:function(){
      ...
      $.each( imgArr , function(index, val) {
        ...
        '<li class="accordion-li">'+
          '<i class="accordion-icon fa '+ val.icon +'"></i>'+
          '<a style="height:350px;" href="'+ val.url +'">'+
            '<img class="accordion-img" src="'+ val.src +'" alt="'+ val.alt +'"/>'+
          '</a>'+
    ...
    responseDOM:function(){
      if(this.defaults.arrangement === "verticality"){
        this.li.css({'width': '99.9%','height':this.defaults.defaultHeight});
        ...
        this.obj.find('ul[data-name="accordion"]').width(this.winWidth + this.winWidth/95);
      }else{
