		...
		<table width="900px" border="0" cellspacing="0">
			<tr>
				...
				<td>
					...
					<table cellspacing="0" class="listcontent" style="width: 100%; height: 230px;">
						<tr>
							<td>
								<h1>商品目录</h1>
								<hr />
										...
										<c:forEach items="${pro }" var="p">
											<td>
												<div class="divbookpic">
													<p>
														<a href="${pageContext.request.contextPath }/book/productDetails?pid=${p.pid}">
															<img src="${pageContext.request.contextPath}/static/${p.pimage}" width="115" height="129" border="0" />
														</a>
													</p>
												</div>
												<div class="divlisttitle">
													<a
														href="${pageContext.request.contextPath }/productServlet?action=productInfo&pid=${p.pid}">商品名:${p.pname }<br />售价:${p.shopPrice}
													</a>
												</div>
											</td>
										</c:forEach>
