...
<link href="${pageContext.request.contextPath}/jsp/admin/css/Style.css"
	rel="stylesheet" type="text/css" />
<script language="javascript"
	src="${pageContext.request.contextPath}/jsp/admin/js/public.js"></script>
<style type="text/css">
.page a{
						...
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<c:forEach items="${list }" var="v">
								...
								onmouseout="this.style.backgroundColor = '#F5FAFE';">
									<td style="CURSOR: hand; HEIGHT: 22px" align="center">${v.oid }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center">${v.name }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center">${v.address }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center">${v.telephone }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center">
										${v.total }</td>
									<td align="center">${v.uname }</td>
									<td align="center">${v.state==0?'未支付':'已支付' }</td>
	
									<td align="center" style="HEIGHT: 22px"><a href="#">
											<img src="${pageContext.request.contextPath}/jsp/admin/images/button_view.gif"
