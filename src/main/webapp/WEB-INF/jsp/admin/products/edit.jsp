...
<script language="javascript" src="${pageContext.request.contextPath}/jsp/admin/js/check.js"></script>
...
<body>
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/man/productUpdate" method="post" enctype="multipart/form-data">
		<input type="hidden" name="pid" value="${p.pid }" />
		<input type="hidden" name="marketPrice" value="${p.market_price }" />
		<input type="hidden" name="pimage" value="${p.pimage }" />
		<input type="hidden" name="pdate" value="${p.pdate }" />
		<input type="hidden" name="isHot" value="${p.is_hot }" />
		<input type="hidden" name="pflag" value="${p.pflag }" />
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
					height="26"><strong>编辑商品</strong></td>
			</tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="pname" class="bg" value="${p.pname }" />
				</td>
				<td align="center" bgColor="#f5fafe" class="ta_01">商品价格：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="shopPrice" class="bg" value="${p.shop_price }" />
				</td>
			</tr>
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">商品数量：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="pnum" class="bg" value="10" /></td>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colSpan="3"><input
					type="file" name="image" size="30" value="" /></td>
			</tr>
			<TR>
