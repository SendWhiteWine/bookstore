	...
	<br>
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe" height="550px">
							...
							<c:forEach items="${list }" var="v">
								<tr onmouseover="this.style.backgroundColor = 'ccc'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="18%">${v.pname }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8%">${v.shopPrice }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8%">10</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center">
										${v.cid }</td>
									<td align="center" style="HEIGHT: 22px" width="7%"><a href="${pageContext.request.contextPath}/man/edit?pid=${v.pid }">
											<img src="${pageContext.request.contextPath}/jsp/admin/images/i_edit.gif"
											border="0" style="CURSOR: hand">
									</a></td>
									<td align="center" style="HEIGHT: 22px" width="7%"><a href="${pageContext.request.contextPath}/man/delete?pid=${v.pid }">
