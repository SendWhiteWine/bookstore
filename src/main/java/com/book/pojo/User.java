...
public class User {
	...
	public String toString() {
		return "User [uid=" + uid + ", uname=" + uname + ", upwd=" + upwd + ", realname=" + realname + ", uemail="
				+ uemail + ", utel=" + utel + ", ubirthday=" + ubirthday + ", ugender=" + ugender + ", state=" + state
				+ ", code=" + code + ", uintroduce=" + uintroduce + "]";
	}
